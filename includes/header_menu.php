...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">Thunderbolt E-store</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#mobile" class="dropdown-item">Mobile phones</a>
                                   <a href="products.php#tv" class="dropdown-item">TVs</a>
                                   <a href="products.php#laptop" class="dropdown-item">Laptops</a>
                                   <a href="products.php#watch" class="dropdown-item">Smart Watches</a>
                               </div>
            ...
            <div class="modal-body">
              <form action="signup_script.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Contact" required>
                </div>
                <div class="form-group">
